...
- open and save files
- keep track of the current turns
- keep track of character/monster stats (hp, temp hp, conditions, etc as well as other basic stats, abilities, feats, etc)
- display a character sheet of the player/monster with the current turn
- allow characters/monsters to be added or removed from the current game. Characters and monsters are stored in xml files
